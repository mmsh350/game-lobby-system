...
export default function useSessionTimer() {
  ...
  //       "http://localhost:8090/api/current-session",
  //       {
  ...
  //     const response = await axios.get(
  //       `http://localhost:8090/api/session-results/${sessionId}`,
  //       { headers: { Authorization: `Bearer ${token}` } }
  //     );

  //     const userSelection = response.data.selections.find(
  ...
  //     if (userSelection) {
  //       setLastResult({
  //         won: userSelection.selected_number === response.data.winning_number,
  //         selectedNumber: userSelection.selected_number,
  //         winningNumber: response.data.winning_number,
  //       });
  //     }
